...
public class SysInfoConnectorConfig extends AbstractConfig {
    ...
    public SysInfoConnectorConfig(ConfigDef config, Map<String, String> parsedConfig) {
        super(config, parsedConfig);
    }

    public SysInfoConnectorConfig(Map<String, String> parsedConfig) {
